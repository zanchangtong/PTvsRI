...
def main() -> None:
    #  Example usage:
    # python trim_mbart.py --pre-train-dir /home/mbart.cc25 --ft-dict /home/data-in/en_XX-de_DE/dict.en_XX.txt --langs ar_AR,cs_CZ,de_DE,en_XX,es_XX,et_EE,fi_FI,fr_XX,gu_IN,hi_IN,it_IT,ja_XX,kk_KZ,ko_KR,lt_LT,lv_LV,my_MM,ne_NP,nl_XX,ro_RO,ru_RU,si_LK,tr_TR,vi_VN,zh_CN --output /home/checkpoints/trimed_mbart/19ende_trimed_mbart.pt
